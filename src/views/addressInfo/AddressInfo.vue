<template>
  <div class="wrapper">
    <div class="title">
      ...
      <div class="title__save" @click="saveAddress">保存</div>
    </div>
    <div class="form">
...
export default {
  ...
  setup() {
    ...
    const { formData, saveAddress } = useFormEffect(addressId)
    const handleBackClick = () => {
      router.back()
    }
    return { addressId, addressList, formData, handleBackClick, saveAddress }
  },
}
</script>
