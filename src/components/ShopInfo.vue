<template>
  <div class="shop">
    <img class="shop__img" :src="item.imgUrl" alt="nearby" />
    <div class="shop__content" :class="{ 'shop__content--border': showBorder }">
      <div class="shop__content__title">{{ item.name }}</div>
      <div class="shop__content__tags">
        <span class="shop__content__tags__tag"> 月售：{{ item.sales }} </span>
